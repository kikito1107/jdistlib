...
public class DIEtiquetaRolActual extends DComponenteBase
{
	 ...
	 *            tiene padre establecer a null
	 * @param textoEtiqueta
	 *            String Cadena de texto que habra antes del nombre del rol. Por
	 *            defecto es "Rol actual:"
	 * @param colorTexto
	 *            Color Color de la cadena de texto que hay antes del rol. Por
	 *            defecto es es color de Foreground del componente
	 * @param colorRol
	 *            Color Color de la cadena de texto del rol. Por defecto es de
	 *            color azul.
	 */
	public DIEtiquetaRolActual( String nombre, boolean conexionDC,
