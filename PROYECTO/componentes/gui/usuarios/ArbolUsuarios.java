...
/**
 * Clase que encapsula el comportamiento del ‡rbol que lista los usuarios por rol
...
public class ArbolUsuarios extends JTree
{
	...
	public void insertarNuevoUsuario(String Rol, String usuario){
		DefaultMutableTreeNode unNodoRol = buscarRol(Rol),
								hijo = new DefaultMutableTreeNode(usuario);
	
		if (Rol != null && usuario != null && usuario != "" && Rol != "" && unNodoRol != null) {
			
			System.out.println("El rol encontrado es " + unNodoRol.getUserObject());			
	...
	/**
	 * Elimina un usuario del arbol
	 * @param Rol rol bajo el que esta actualmente el usuario
	 ...
	 * @param antiguoRol rol actual del usuario
	 ...
	 * @param Rol rol bajo el que se encuentra actualmete el usuario
	 * @param usuario nombre del usuario
	 ...
	 * @param ramaRol nodo en el que se encuentra el usuario
	 * @param usuario nombre del usuario
	 * @return indice donde se encuentra el usuario
	 */
	public DefaultMutableTreeNode buscarUsuario(DefaultMutableTreeNode ramaRol, String usuario) {
