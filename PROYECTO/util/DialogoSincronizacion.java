...
public class DialogoSincronizacion
	 extends JDialog {
	 ...
	 public void run() {
		...
		while (true) {
		  try {
			 ...
			 // Si no debe parpadear se quedará bloqueado hasta que se indique
			 // lo contrario
...
class MensajesIni_this_windowAdapter
