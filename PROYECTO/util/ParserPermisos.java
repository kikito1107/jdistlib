...
public class ParserPermisos
{
	 ...
	 * @return true si el usuario puede acceder al fichero y false en caso contrario
	 */
	public static boolean comprobarPermisoLectura(FicheroBD f, String  u, String r) {
		...
		if (u == null || r == null)
			...
			// 3) el usuario no esta ni en 1) ni en 2)
			else {
				if (permisos.charAt(4) == 'r')
					res = true;
				else 
					res = false;
			}
	 ...
	 * @return true si el usuario puede acceder al fichero y false en caso contrario
	 */
	public static boolean comprobarPermisoEscritura(FicheroBD f, String  u, String r) {
