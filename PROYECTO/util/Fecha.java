...
/**
 * Clase utilizada para realizar varias operaciones de formateo de texto, número
 * y fechas.<br>
 * 
...
public class Fecha
{
	...
	/**
	 * Construye una clase Fecha con la fecha y hora por defecto. La hora está
	 * en formato 24 horas.
	 */
	public Fecha()
	{
	...
	/**
	 * Construye un objeto Fecha con la fecha y hora pasados por parámetros
	 * BigDecimal
	 * 
	 * @param year
	 *            BigDecimal
	 ...
	 * parámetro según el formato indicado
	 * 
	 * @param fecha
	 *            String
	 * @param formato
	...
	/**
	 * Compara dos fechas entre sí Parámetros de entrada: - fecha: variable de
	 * tipo Date que recibe la función Parámetros de salida: - -1: si la fecha
	 * es mayor que la pasada por parámetro - 0: si la fecha introducida es
	 * igual - 1: si la fecha es menor que la pasada por parámetro
	 */
