...
public class TablaElementos extends JTable {
  ...
  /**
   * @param nombreColumnas Array con el nombre de cada una de las columnas
   */
   ...
   * @param fila Fila que deseamos añadir
   */
   ...
   * @param filas Filas que deseamos añadir
   */
   ...
   * @param fila Numero de la fila que deseamos obtener
  ...
  public void setAnchoColumna(int indexColumna, int tamanio){
    this.getColumnModel().getColumn(indexColumna).setPreferredWidth(tamanio);
  }
...
//**************************************************************
  ...
  private class ModeloTabla extends AbstractTableModel {
    ...
    /**
     * @param nombreColumnas Nombre de cada una de las columnas
     */
     ...
     * @param col Columna de la que queremos saber el nombre
     ...
     * @param row Fila de la celda de la que queremos conocer el valor
     * @param col Columna de la celda de la que queremos conocer el valor
     ...
     * @param row Fila de la celda para la que queremos conocer si es editable
     * @param col Columna de la celda para la que queremos conocer si es editable
     * @return En la actual implementacion ninguna de las columnas es editable por
     * lo que devuelve siempre false
     */
    ...
    /**
     * Añadir una fila a la tabla
     * @param fila Fila que queremos insertar
     */
    ...
    /**
     * Obtener una fila
     * @param numFila Numero de la fila que queremos obtener
     * @return Fila deseada
     */
