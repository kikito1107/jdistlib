 ...
 * @author Arnaud Weber
 */
public class DMetalPopupMenuUI
	 extends PopupMenuUI {
  ...
  static InputMap getInputMap(JPopupMenu popup, JComponent c) {
	 ...
	 if (bindings != null) {
		...
		if (!popup.getComponentOrientation().isLeftToRight()) {
		  ...
		  if (km != null) {
			 InputMap rightToLeftInputMap = LookAndFeel.makeComponentInputMap(c,
				  km);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  /**
	...
	* @since 1.4
	*/
  private class metalPopupMenuListener
	 ...
	 public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
		...
		if (map != null) {
		  ...
		  if (audioAction != null) {
			 ...
			 MetalLookAndFeel lf = (MetalLookAndFeel)
...
// Se comenta por razones de acceso. Aparentemente no habrá problemas ya
// que esta clase solo se usará para el popup del JComboBox
