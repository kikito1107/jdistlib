 ...
 * @author Tom Santos
 */
public class DMetalToggleButtonUI
	 extends BasicToggleButtonUI {

  private static final DMetalToggleButtonUI metalToggleButtonUI = new
		DMetalToggleButtonUI();
	...
	private class ButtonListener
	  ...
	  public void mousePressed(MouseEvent e) {
		 ...
		 if (SwingUtilities.isLeftMouseButton(e)) {
			...
			if (b.contains(e.getX(), e.getY())) {
			  ...
			  // Se comenta para que solo se tome en consideracion el mouse released
			  Vector v = ( (DJToggleButton) b).getDJToggleButtonListeners();
			  DJToggleButtonEvent evento = new DJToggleButtonEvent();
			  evento.tipo = new Integer(DJToggleButtonEvent.PRESIONADO.intValue());
			  for (int i = 0; i < v.size(); i++) {
				 ( (DJToggleButtonListener) v.elementAt(i)).presionado(evento);
			  }
			}
		 }
	  };
	  ...
	  public void mouseReleased(MouseEvent e) {
		 if (SwingUtilities.isLeftMouseButton(e)) {
			...
			// Al haber deshabilitado los eventos de entrada y salida del puntero siempre
			// que se produzca un evento mouseReleased cambiará la seleccion del togglebutton
			...
			Vector v = ( (DJToggleButton) b).getDJToggleButtonListeners();
			DJToggleButtonEvent evento = new DJToggleButtonEvent();
			evento.tipo = new Integer(DJToggleButtonEvent.SOLTADO.intValue());
			for (int i = 0; i < v.size(); i++) {
