...
public class DMetalButtonListener
  ...
  InputMap getInputMap(int condition, JComponent c) {
	 if (condition == JComponent.WHEN_FOCUSED) {
		...
		if (ui != null && (ui instanceof BasicButtonUI)) {
		  // Comentamos esto ya que no suponen ningun problema para el funcionamiento
		  // de DMetalButtonUI
  ...
  public void mousePressed(MouseEvent e) {
	 if (SwingUtilities.isLeftMouseButton(e)) {
		...
		if (b.contains(e.getX(), e.getY())) {
		  ...
		  // Comentado ya que estas acciones se deben realizar una vez se reciba
