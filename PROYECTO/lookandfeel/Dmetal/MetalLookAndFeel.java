...
public class MetalLookAndFeel
  ...
  /**
	...
	* which this method maps to "lookandfeel.Dmetal.MetalButtonUI".
	*
  ...
  protected void initClassDefaults(UIDefaults table) {
	 ...
	 Object[] uiDefaults = {
		  ...
		  "DButtonUI", metalPackageName + "DMetalButtonUI",
		  "CheckBoxUI", metalPackageName + "MetalCheckBoxUI",
		  "DCheckBoxUI", metalPackageName + "DMetalCheckBoxUI",
		  "ComboBoxUI", metalPackageName + "MetalComboBoxUI",
		  "DComboBoxUI", metalPackageName + "DMetalComboBoxUI",
		  ...
		  "DListUI", metalPackageName + "DMetalListUI",
		  "DMenuMetalPopupMenuUI", metalPackageName + "DMenuMetalPopupMenuUI",
		  "DMenuMetalMenuUI", metalPackageName + "DMenuMetalMenuUI",
		  "DMenuMetalMenuItemUI", metalPackageName + "DMenuMetalMenuItemUI",
		  "DDD", metalPackageName + "DMetalPopupMenuUI",
  ...
  protected void initSystemColorDefaults(UIDefaults table) {
	 Object[] systemColors = {
		  ...
		  "activeCaption",
		  getWindowTitleBackground(), /* Color for captions (title bars) when they are active. */
		  "activeCaptionText",
		  getWindowTitleForeground(), /* Text color for text in captions (title bars). */
		  "activeCaptionBorder",
		  getPrimaryControlShadow(), /* Border color for caption (title bar) window borders. */
		  "inactiveCaption",
		  getWindowTitleInactiveBackground(), /* Color for captions (title bars) when not active. */
		  "inactiveCaptionText",
		  getWindowTitleInactiveForeground(), /* Text color for text in inactive captions (title bars). */
		  "inactiveCaptionBorder",
		  getControlShadow(), /* Border color for inactive caption (title bar) window borders. */
		  "window",
		  getWindowBackground(), /* Default color for the interior of windows */
		  ...
		  "textHighlight",
		  getTextHighlightColor(), /* Text background color when selected */
		  "textHighlightText",
		  getHighlightedTextColor(), /* Text color when selected */
		  "textInactiveText",
		  getInactiveSystemTextColor(), /* Text color when disabled */
		  "control",
		  getControl(), /* Default color for controls (buttons, sliders, etc) */
		  "controlText",
		  getControlTextColor(), /* Default color for text in controls */
		  "controlHighlight",
		  getControlHighlight(), /* Specular highlight (opposite of the shadow) */
		  "controlLtHighlight",
		  getControlHighlight(), /* Highlight color for controls */
		  "controlShadow", getControlShadow(), /* Shadow color for controls */
		  "controlDkShadow",
		  getControlDarkShadow(), /* Dark shadow color for controls */
		  "scrollbar",
		  getControl(), /* Scrollbar background (usually the "track") */
  ...
  protected void initComponentDefaults(UIDefaults table) {
	 ...
	 table.putDefaults(new Object[]
				{
				"OptionPane.errorIcon", LookAndFeel.makeIcon(javax.swing.plaf.metal.MetalLookAndFeel.class, "icons/Error.gif"),
				"OptionPane.informationIcon", LookAndFeel.makeIcon(javax.swing.plaf.metal.MetalLookAndFeel.class, "icons/Inform.gif"),
				"OptionPane.warningIcon", LookAndFeel.makeIcon(javax.swing.plaf.metal.MetalLookAndFeel.class, "icons/Warn.gif"),
				"OptionPane.questionIcon", LookAndFeel.makeIcon(javax.swing.plaf.metal.MetalLookAndFeel.class, "icons/Question.gif"),
				});
	 ...
	 Object textFieldBorder =
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalBorders",
												  "getTextFieldBorder");
	 ...
	 Object desktopIconBorder =
		  new UIDefaults.ProxyLazyValue(
		  "lookandfeel.Dmetal.MetalBorders",
	 ...
	 Object[] defaults = {
		  ...
		  "CheckBox.icon",
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalIconFactory",
												  "getCheckBoxIcon"),
		  ...
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalBorders$InternalFrameBorder"),
		  "InternalFrame.optionDialogBorder",
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalBorders$OptionDialogBorder"),
		  "InternalFrame.paletteBorder",
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalBorders$PaletteBorder"),
		  "InternalFrame.paletteTitleHeight", new Integer(11),
		  "InternalFrame.paletteCloseIcon",
		  new UIDefaults.ProxyLazyValue("lookandfeel.Dmetal.MetalIconFactory$PaletteCloseIcon"),
...
/**
 * Se incluye dado que no se puede acceder directamente a este método
 * en su superclase dado las restricciones de acceso
 * @return ActionMap
 */
