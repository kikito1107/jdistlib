 ...
 * <p>
 * For the keyboard keys defined for each component in this look and feel, see
 * <a href="../../doc-files/Key-Metal.html">Component Keystroke Actions for the
 * Java Look and Feel.</a>
 * <p>
...
public class MetalLookAndFeel extends BasicLookAndFeel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2662174200404171988L;
	...
	static boolean isWindows()
	{
		if (!checkedWindows)
		{
			...
			{
				isWindows = true;
				String systemFonts = (String) AccessController
	 ...
	 * <p>
	 * This implementation returns true, since it does support providing these
	 * border and window title pane decorations.
	 * 
	...
	/**
	 * Creates the mapping from UI class IDs to <code>ComponentUI</code>
	 * classes, putting the ID-<code>ComponentUI</code> pairs in the
	 * passed-in defaults table. Each <code>JComponent</code> class specifies
	 * its own UI class ID string. For example, <code>JButton</code> has the
	 * UI class ID "ButtonUI", which this method maps to
	 * "lookandfeel.Dmetal.MetalButtonUI".
	 * 
	...
	protected void initClassDefaults(UIDefaults table)
	{
		...
		String metalPackageName = "lookandfeel.Dmetal.";

		Object[] uiDefaults =
		{ "ButtonUI", metalPackageName + "MetalButtonUI", "DButtonUI",
				metalPackageName + "DMetalButtonUI", "CheckBoxUI",
				metalPackageName + "MetalCheckBoxUI", "DCheckBoxUI",
				metalPackageName + "DMetalCheckBoxUI", "ComboBoxUI",
				metalPackageName + "MetalComboBoxUI", "DComboBoxUI",
				metalPackageName + "DMetalComboBoxUI", "DesktopIconUI",
				...
				metalPackageName + "MetalLabelUI", "DListUI",
				metalPackageName + "DMetalListUI", "DMenuMetalPopupMenuUI",
				metalPackageName + "DMenuMetalPopupMenuUI", "DMenuMetalMenuUI",
				metalPackageName + "DMenuMetalMenuUI", "DMenuMetalMenuItemUI",
				metalPackageName + "DMenuMetalMenuItemUI", "DDD",
				metalPackageName + "DMetalPopupMenuUI", "PopupMenuSeparatorUI",
				metalPackageName + "MetalPopupMenuSeparatorUI",
				...
				"SliderUI", metalPackageName + "MetalSliderUI", "SplitPaneUI",
				metalPackageName + "MetalSplitPaneUI", "TabbedPaneUI",
				metalPackageName + "MetalTabbedPaneUI", "TextFieldUI",
				metalPackageName + "MetalTextFieldUI", "DTextFieldUI",
				metalPackageName + "DMetalTextFieldUI", "ToggleButtonUI",
				metalPackageName + "MetalToggleButtonUI", "DToggleButtonUI",
				metalPackageName + "DMetalToggleButtonUI", "ToolBarUI",
				metalPackageName + "MetalToolBarUI", "ToolTipUI",
				metalPackageName + "MetalToolTipUI", "TreeUI",
				metalPackageName + "MetalTreeUI", "DTreeUI",
				metalPackageName + "DMetalTreeUI", "RootPaneUI",
	...
	{
		table
				.addResourceBundle("com.sun.swing.internal.plaf.metal.resources.metal");
	}
	...
	protected void initComponentDefaults(UIDefaults table)
	{
		...
		// Para solucionar que no se encuentran las imagenes para el JOptionPane
		...
		Object textFieldBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders", "getTextFieldBorder");

		Object textBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders", "getTextBorder");

		Object dialogBorder = new MetalLazyValue(
				"lookandfeel.Dmetal.MetalBorders$DialogBorder");

		Object questionDialogBorder = new MetalLazyValue(
				"lookandfeel.Dmetal.MetalBorders$QuestionDialogBorder");
		...
		Object scrollPaneBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders$ScrollPaneBorder");
		Object buttonBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders", "getButtonBorder");

		Object toggleButtonBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders", "getToggleButtonBorder");
		...
		Object desktopIconBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders", "getDesktopIconBorder");

		Object menuBarBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders$MenuBarBorder");

		Object popupMenuBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders$PopupMenuBorder");
		Object menuItemBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders$MenuItemBorder");

		Object menuItemAcceleratorDelimiter = new String("-");
		Object toolBarBorder = new UIDefaults.ProxyLazyValue(
				"lookandfeel.Dmetal.MetalBorders$ToolBarBorder");

		Object progressBarBorder = new UIDefaults.ProxyLazyValue(
				"javax.swing.plaf.BorderUIResource$LineBorderUIResource",
				new Object[]
				{ getControlDarkShadow(), new Integer(1) });
		...
		Object[] defaults =
		{
				...
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalIconFactory",
						"getCheckBoxIcon"),
				...
				new UIDefaults.LazyInputMap(new Object[]
				{ "ESCAPE", "cancelSelection", "BACK_SPACE", "Go Up", "ENTER",
						"approveSelection" }),
				// ToolTip
				"ToolTip.font",
				systemTextValue,
				...
				new UIDefaults.LazyInputMap(new Object[]
				{ "RIGHT", "positiveUnitIncrement", "KP_RIGHT",
				...
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalBorders$InternalFrameBorder"),
				"InternalFrame.optionDialogBorder",
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalBorders$OptionDialogBorder"),
				"InternalFrame.paletteBorder",
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalBorders$PaletteBorder"),
				"InternalFrame.paletteTitleHeight",
				new Integer(11),
				"InternalFrame.paletteCloseIcon",
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalIconFactory$PaletteCloseIcon"),
				...
				"sounds/FrameClose.wav",
				"InternalFrame.maximizeSound",
				"sounds/FrameMaximize.wav",
				"InternalFrame.minimizeSound",
				"sounds/FrameMinimize.wav",
				"InternalFrame.restoreDownSound",
				"sounds/FrameRestoreDown.wav",
				...
				new UIDefaults.LazyInputMap(new Object[]
				{ "ctrl F5", "restore", "ctrl F4", "close", "ctrl F7", "move",
						"ctrl F8", "resize", "RIGHT", "right", "KP_RIGHT",
						"right", "shift RIGHT", "shrinkRight",
						"shift KP_RIGHT", "shrinkRight", "LEFT", "left",
						"KP_LEFT", "left", "shift LEFT", "shrinkLeft",
						"shift KP_LEFT", "shrinkLeft", "UP", "up", "KP_UP",
						"up", "shift UP", "shrinkUp", "shift KP_UP",
						"shrinkUp", "DOWN", "down", "KP_DOWN", "down",
						"shift DOWN", "shrinkDown", "shift KP_DOWN",
						"shrinkDown", "ESCAPE", "escape", "ctrl F9",
						"minimize", "ctrl F10", "maximize", "ctrl F6",
						"selectNextFrame", "ctrl TAB", "selectNextFrame",
						"ctrl alt F6", "selectNextFrame", "shift ctrl alt F6",
						"selectPreviousFrame", "ctrl F12", "navigateNext",
				...
				{ "ctrl C", "copy", "ctrl V", "paste", "ctrl X", "cut", "COPY",
						"copy", "PASTE", "paste", "CUT", "cut", "UP",
						"selectPreviousRow", "KP_UP", "selectPreviousRow",
						"shift UP", "selectPreviousRowExtendSelection",
						"shift KP_UP", "selectPreviousRowExtendSelection",
						"DOWN", "selectNextRow", "KP_DOWN", "selectNextRow",
						"shift DOWN", "selectNextRowExtendSelection",
						"shift KP_DOWN", "selectNextRowExtendSelection",
						"LEFT", "selectPreviousColumn", "KP_LEFT",
						...
						"HOME", "selectFirstRow", "shift HOME",
						"selectFirstRowExtendSelection", "END",
						"selectLastRow", "shift END",
						"selectLastRowExtendSelection", "PAGE_UP", "scrollUp",
						"shift PAGE_UP", "scrollUpExtendSelection",
						"PAGE_DOWN", "scrollDown", "shift PAGE_DOWN",
						"scrollDownExtendSelection", "ctrl A", "selectAll",
				...
				new UIDefaults.LazyInputMap(new Object[]
				{ "RIGHT", "unitScrollRight", "KP_RIGHT", "unitScrollRight",
				...
				{ "RIGHT", "navigateRight", "KP_RIGHT", "navigateRight",
						...
						"UP", "navigateUp", "KP_UP", "navigateUp", "DOWN",
				...
				scrollPaneBorder,
				"Table.gridColor",
				getControlShadow(), // grid line color
				"Table.ancestorInputMap",
				new UIDefaults.LazyInputMap(new Object[]
				{ "ctrl C", "copy", "ctrl V", "paste", "ctrl X", "cut", "COPY",
						"copy", "PASTE", "paste", "CUT", "cut", "RIGHT",
						"selectNextColumn", "KP_RIGHT", "selectNextColumn",
						"LEFT", "selectPreviousColumn", "KP_LEFT",
						"selectPreviousColumn", "DOWN", "selectNextRow",
						"KP_DOWN", "selectNextRow", "UP", "selectPreviousRow",
						"KP_UP", "selectPreviousRow", "shift RIGHT",
						...
						"scrollDownChangeSelection", "HOME",
						"selectFirstColumn", "END", "selectLastColumn",
						"shift PAGE_UP", "scrollUpExtendSelection",
						...
						"ctrl HOME", "selectFirstRow", "ctrl END",
						"selectLastRow", "ctrl shift PAGE_UP",
						"scrollRightExtendSelection", "ctrl shift PAGE_DOWN",
						"scrollLeftExtendSelection", "ctrl shift HOME",
						"selectFirstRowExtendSelection", "ctrl shift END",
						"selectLastRowExtendSelection", "TAB",
				...
				new UIDefaults.ProxyLazyValue(
						"lookandfeel.Dmetal.MetalBorders$TableHeaderBorder"),
				// MenuBar
				"MenuBar.border",
				menuBarBorder,
				"MenuBar.font",
				...
				"sounds/OptionPaneInformation.wav",
				"OptionPane.warningSound",
				"sounds/OptionPaneWarning.wav",
				...
				new UIDefaults.LazyInputMap(
						...
						{ "UP", "negativeIncrement", "DOWN",
								...
								"positiveIncrement", "HOME", "selectMin",
								"END", "selectMax", "F8", "startResize", "F6",
				...
				"Tree.line",
				getPrimaryControl(), // horiz lines
				"Tree.hash",
				getPrimaryControl(), // legs
				"Tree.rowHeight",
				new Integer(0),
				"Tree.focusInputMap",
				new UIDefaults.LazyInputMap(new Object[]
				{ "ctrl C", "copy", "ctrl V", "paste", "ctrl X", "cut", "COPY",
						...
						"selectNextExtendSelection", "RIGHT", "selectChild",
						"KP_RIGHT", "selectChild", "LEFT", "selectParent",
						"KP_LEFT", "selectParent", "PAGE_UP",
						"scrollUpChangeSelection", "shift PAGE_UP",
						"scrollUpExtendSelection", "PAGE_DOWN",
						"scrollDownChangeSelection", "shift PAGE_DOWN",
						"scrollDownExtendSelection", "HOME", "selectFirst",
						"shift HOME", "selectFirstExtendSelection", "END",
						"selectLast", "shift END", "selectLastExtendSelection",
						"F2", "startEditing", "ctrl A", "selectAll",
						"ctrl SLASH", "selectAll", "ctrl BACK_SLASH",
						"clearSelection", "ctrl SPACE",
						"toggleSelectionPreserveAnchor", "shift SPACE",
						"extendSelection", "ctrl HOME",
						"selectFirstChangeLead", "ctrl END",
						"selectLastChangeLead", "ctrl UP",
						"selectPreviousChangeLead", "ctrl KP_UP",
						"selectPreviousChangeLead", "ctrl DOWN",
						"selectNextChangeLead", "ctrl KP_DOWN",
						"selectNextChangeLead", "ctrl PAGE_DOWN",
						"scrollDownChangeLead", "ctrl shift PAGE_DOWN",
						"scrollDownExtendSelection", "ctrl PAGE_UP",
						"scrollUpChangeLead", "ctrl shift PAGE_UP",
						"scrollUpExtendSelection", "ctrl LEFT", "scrollLeft",
						"ctrl KP_LEFT", "scrollLeft", "ctrl RIGHT",
						"scrollRight", "ctrl KP_RIGHT", "scrollRight", "SPACE",
				...
				new UIDefaults.LazyInputMap(new Object[]
				{ "UP", "navigateUp", "KP_UP", "navigateUp", "DOWN",
						"navigateDown", "KP_DOWN", "navigateDown", "LEFT",
						"navigateLeft", "KP_LEFT", "navigateLeft", "RIGHT",
						"navigateRight", "KP_RIGHT", "navigateRight" }),
				// RootPane
				"RootPane.frameBorder",
				new MetalLazyValue(
						"lookandfeel.Dmetal.MetalBorders$FrameBorder"),
				...
				new MetalLazyValue(
						"lookandfeel.Dmetal.MetalBorders$ErrorDialogBorder"),
				...
				new MetalLazyValue(
						"lookandfeel.Dmetal.MetalBorders$WarningDialogBorder"),
				// These bindings are only enabled when there is a default
				// button set on the rootpane.
				"RootPane.defaultButtonWindowKeyBindings",
				new Object[]
				{ "ENTER", "press", "released ENTER", "release", "ctrl ENTER",
						"press", "ctrl released ENTER", "release" }
		...
		if (isWindows() && useSystemFonts() && theme.isSystemTheme())
		{
			...
			Object messageFont = new MetalFontDesktopProperty(
					"win.messagebox.font.height", kit,
					MetalTheme.CONTROL_TEXT_FONT);

			defaults = new Object[]
			{ "OptionPane.messageFont", messageFont, "OptionPane.buttonFont",
					messageFont, };
			table.putDefaults(defaults);
	...
	private static MetalTheme getCurrentTheme()
	{
		...
		if (cachedAppContext != context)
		{
			...
			if (currentTheme == null)
			{
				...
				else currentTheme = new DefaultMetalTheme();
	...
	/**
	 * Se incluye dado que no se puede acceder directamente a este método en su
