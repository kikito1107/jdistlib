...
public class DefaultMetalTheme extends MetalTheme
{
	...
	private static class FontDelegate
	{
		...
		{ CONTROL_TEXT_FONT, SYSTEM_TEXT_FONT, USER_TEXT_FONT,
		...
		/**
		 * This is the same as invoking <code>Font.getFont(key)</code>, with
		 * the exception that it is wrapped inside a <code>doPrivileged</code>
		 * call.
		 */
		...
		{
			return (Font) java.security.AccessController
