...
public class Componente4
  ...
  public Componente4(String nombre, boolean conexionDC,
  ...
  void jbInit() throws Exception {
	 ...
	 botonEliminar.addActionListener(new Componente4_botonEliminar_actionAdapter(this));
	 jLabel1.setFont(new java.awt.Font("Dialog", 1, 15));
	 jLabel1.setHorizontalAlignment(SwingConstants.CENTER);
	 jLabel1.setHorizontalTextPosition(SwingConstants.CENTER);
	 jLabel1.setText("Aplicacion de ejemplo 4");
  ...
  /**
	...
	* @return int Número de componentes hijos. En este caso devuelve 3 (la lista
	* izquierda, el boton y la lista derecha)
	*/
...
class Componente4_botonCambio_actionAdapter
	 implements java.awt.event.ActionListener {
  Componente4 adaptee;

  Componente4_botonCambio_actionAdapter(Componente4 adaptee) {
...
class Componente4_botonEliminar_actionAdapter
	 implements java.awt.event.ActionListener {
  Componente4 adaptee;

  Componente4_botonEliminar_actionAdapter(Componente4 adaptee) {
	 this.adaptee = adaptee;
  }
