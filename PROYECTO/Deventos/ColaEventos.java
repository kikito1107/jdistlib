 ...
 * Cuando un usuario intenta extraer un evento y no hay ninguno quedara bloqueado
...
public class ColaEventos {
  ...
  /**
	...
	* @param e DEvent Evento a introducir
	*/
  ...
  /**
	* Extrae un evento de la cola. Si la cola esta vacia el que llama al
	* metodo quedara bloqueado hasta que haya eventos en la cola que extraer.
