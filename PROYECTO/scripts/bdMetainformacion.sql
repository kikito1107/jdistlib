...
CREATE TABLE `Aplicacion` (
  ...
  `nombre_aplicacion` varchar(256) NOT NULL default '',
...
CREATE TABLE `Rol` (
  ...
  `nombre_rol` varchar(256) NOT NULL default '',
  PRIMARY KEY  (`id_rol`),
...
INSERT INTO `Rol` VALUES (1,'Boss'),(3,'Ejecutive'),(6,'Externall Asistant'),(4,'Janitor'),(2,'Manager'),(5,'Unknown');
...
CREATE TABLE `Usuario` (
  ...
  `nombre_usuario` varchar(256) NOT NULL default '',
  `clave` varchar(256) NOT NULL default '',
...
INSERT INTO `Usuario` VALUES (1,'Ana','clave',1,1),(2,'Carlos','clave',2,1),(3,'Jose','clave',5,0),(4,'Peter','clave',3,0),(5,'Elena','clave',4,0),(6,'Susan','clave',2,0);
...
INSERT INTO `permisosRol` VALUES (1,1,0),(1,2,20),(1,5,20),(1,22,20),(1,40,20),(1,47,20),(1,48,20),(1,49,20),(1,51,20),(2,3,20),(2,22,20),(2,47,20),(2,48,20),(2,49,20),(2,51,20);
...
INSERT INTO `permisosUsuario` VALUES (1,1,20),(1,2,20),(1,5,20),(1,22,20),(1,40,20),(1,47,20),(1,48,20),(1,49,20),(1,51,20),(2,1,20),(2,2,20),(2,5,20),(2,22,20),(2,40,20),(2,47,20),(2,48,20),(2,49,20),(2,51,20),(3,49,20),(3,51,20),(4,49,20),(4,51,20),(5,49,20),(5,51,20),(6,49,20),(6,51,20);
