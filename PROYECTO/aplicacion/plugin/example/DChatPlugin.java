	...
	private class PanelControlChat extends JPanel
	{
		...
		private JButton getBotonNuevoPrivado()
		{
			if (botonNuevoPrivado == null)
			{
				...
				botonNuevoPrivado.setToolTipText("Invitar a un usuario a iniciar una conversaci—n privada");
		...
		private JButton getBotonGuardarConversacion()
		{
			if (botonGuardarConversacion == null)
			{
				...
				botonGuardarConversacion.setToolTipText("Guarda la conversaci—n en un documento de texto");
				botonGuardarConversacion.addActionListener(new java.awt.event.ActionListener()
				{
					public void actionPerformed(java.awt.event.ActionEvent e)
					{
						...
						int op = jfc.showDialog(null, "Guardar Conversaci—n");
