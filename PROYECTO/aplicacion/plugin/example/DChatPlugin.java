...
public class DChatPlugin extends DAbstractPlugin
{
	...
	public void init() throws Exception
	{
		...
		arbol = new ArbolUsuariosConectadosRol(
				"ListaUsuariosConectadosRol", true, null);
		chat = new DIChat("chat", true, null);
		
		JPanel oeste = new JPanel(new BorderLayout()), centro = new JPanel(new BorderLayout());
	...
	private class PanelControlChat extends JPanel
	{
		...
		private JButton getBotonNuevoPrivado()
		{
			if (botonNuevoPrivado == null)
			{
				...
				botonNuevoPrivado.setIcon(new ImageIcon(getClass().getResource("/Resources/comments.png")));
				botonNuevoPrivado.setToolTipText("Invitar a un usuario a iniciar una conversación privada");
				this.botonNuevoPrivado.setBorder(null);
				this.botonNuevoPrivado.setBorderPainted(false);
				botonNuevoPrivado.addActionListener(new java.awt.event.ActionListener()
				{
		...
		private JButton getBotonNuevaVC()
		{
			if (botonNuevaVC == null)
			{
				...
				botonNuevaVC.setIcon(new ImageIcon(getClass().getResource("/Resources/webcam.png")));
		...
		private JButton getBotonSalir()
		{
			if (botonSalir == null)
			{
				...
				botonSalir.setIcon(new ImageIcon(getClass().getResource("/Resources/cancel.png")));
		...
		private JButton getBotonGuardarConversacion()
		{
			if (botonGuardarConversacion == null)
			{
				...
				botonGuardarConversacion.setIcon(new ImageIcon(getClass().getResource("/Resources/disk_local.png")));
				botonGuardarConversacion.setToolTipText("Guarda la conversación en un documento de texto");
				botonGuardarConversacion.addActionListener(new java.awt.event.ActionListener()
				{
					public void actionPerformed(java.awt.event.ActionEvent e)
					{
						...
						int op = jfc.showDialog(null, "Guardar Conversación");
						...
						if (op == JFileChooser.APPROVE_OPTION)
						{
							...
							try
							{
								...
								output.write("Chat Log  saved at " + hora + " on " + fecha + ":\n" + chat.getTexto());
								output.close();
							}
		...
		private JButton getBotonLimpiar()
		{
			if (botonLimpiar == null)
			{
				...
				botonLimpiar.setIcon(new ImageIcon(getClass().getResource("/Resources/edit-clear_16x16.png")));
		...
		private JButton getBotonFuente()
		{
			if (botonFuente == null)
			{
				...
				botonFuente.setIcon(new ImageIcon(getClass().getResource("/Resources/font.png")));
				botonFuente.addActionListener(new java.awt.event.ActionListener()
				{
					public void actionPerformed(java.awt.event.ActionEvent e)
					{
