...
public class DJPizarraEvent extends DJViewerEvent
{
	...
	public static final Integer NUEVA_ANOTACION = new Integer(SINCRONIZACION.intValue()+2 );
	...
	public static final Integer REHACER = new Integer(SINCRONIZACION.intValue()+7);
