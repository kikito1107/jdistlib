...
public class ConectorBD
{
	...
	static
	{
		...
		{
			System.err
					.println("Error en apertura de fichero de Conexion de BD. No se ha encontrado el fichero IPGestorBD.txt");
			System.exit(1);
		}
		...
		{
			System.err
					.println("Error en lectura de la iIP desde el fichero IPGestorBD.txt");
			System.exit(3);
		}
		if (( user == null ) || user.equals(""))
		{
			System.err
					.println("Error en lectura del USUARIO desde el fichero IPGestorBD.txt");
			System.exit(3);
		}
		if (( pass == null ) || pass.equals(""))
		{
			System.err
					.println("Error en lectura del PASSWORD desde el fichero IPGestorBD.txt");
			System.exit(3);
		}
		cadena_conexion = new String("jdbc:mysql://" + ip + "/Metainformacion");
	}
