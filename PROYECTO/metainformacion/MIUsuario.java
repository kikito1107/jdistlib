...
/**
 * <p>Description: Clase que representa un usuario de una aplicacion. Guardamos
 ...
 * todos), rol por defecto y estado del usuario (conectado/desconectado)</p>
...
private String nombreUsuario = null;
  ...
  /**
	* Obtiene el rol actual del usuario. Solo tiene sentido si el usuario
	* está conectado
  ...
  /**
	...
	* @param rol String Rol que le deseamos especificar
	*/
  ...
  /**
	...
	* @param rol String Nombre del rol sobre el que queremos saber si se tiene
	* o no permiso.
  ...
  public boolean tieneRolPermitido(String rol) {
	 ...
	 while (!encontrado && i < rolesPermitidos.size()) {
		aux = (String) rolesPermitidos.elementAt(i);
		if (aux.equals(rol)) {
		  encontrado = true;
		}
		i++;
  ...
  /**
	...
	* @param rol String Nuevo rol que se le permite
	*/
  ...
  /**
	...
	* @param componente String Componente sobre el que deseamos obtener informacion.
  ...
  public int getPermisoComponente(String componente) {
	 ...
	 if (aux != null) {
		permiso = aux.permisoComponente();
	 }
	 return permiso;
  }

  /**
	* Cambia el permiso del componente para el usuario. Si no existe el componente
	* se añade un nuevo componente con el permiso indicado
	* @param componente String Componente al que se quiere cambiar el permiso
	* @param permiso int Nuevo permiso que deseamos establecer al componente
	*/
  ...
  /**
	...
	* @param componente String Componente que deseamos añadir
	* @param permiso int Permiso con el que queremos añadir el componente
	*/
  ...
  /**
	* Obtenemos los componentes para los que se ha especificado algun
	* permiso
	* @return Vector Vector de MIComponente con los componentes para los que
	* se ha definido algun permiso
	*/
  ...
  /**
	...
	* @return Vector Vector de String con los nombres de los roles permitidos
	* a este usuario
	*/
  ...
  /**
	...
	* @param b boolean Estado del usuario que deseamos establecer. True para
	* indicar que esta online y False para indicar que esta desconectado
	*/
  ...
  /**
	...
	* @return boolean Devolvera True si esta conectado o False en caso contrario.
	*/
...
//*********** FUNCIONES DE APOYO **********************************************
	 ...
	 * @param nombreComponente String Nombre del componente que queremos obtener
	 * @return MIComponente La instancia del componente buscado. Si no existe
	 * un componente con ese nombre devuelve null.
	 */
	private MIComponente getComponente(String nombreComponente) {
	  ...
	  while (encontrado == null && i < permisosComponentes.size()) {
		 aux = (MIComponente) permisosComponentes.elementAt(i);
  ...
  /**
	...
	* indicado
	* @param rol String Rol sobre el que deseamos buscar informacion
  ...
  public String toString() {
	 ...
	 for (i = 0; i < rolesPermitidos.size(); i++) {
		cadena = new String(cadena + "  " + (String) rolesPermitidos.elementAt(i) +
								  "\n");
	 }
	 cadena = new String(cadena + "Permisos componentes:\n");
	 for (i = 0; i < permisosComponentes.size(); i++) {
		MIComponente aux = (MIComponente) permisosComponentes.elementAt(i);
