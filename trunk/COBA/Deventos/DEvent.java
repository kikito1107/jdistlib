...
public class DEvent
  ...
  public Long contador = null; // Número de secuencia del evento
  ...
  public String nombreComponente = null; // Nombre del componente que genera el evento
  public Integer ultimoProcesado = null; // Último evento procesado por el componente
  ...
  /**
	...
	* @param evento DEvent Evento de referencia para generar el nuevo evento
	*/
  public DEvent(DEvent evento) {
	 this.origen = (this.origen == null) ? null :
		  new Integer(evento.origen.intValue());
	 this.destino = (this.destino == null) ? null :
		  new Integer(evento.destino.intValue());
	 this.contador = (this.contador == null) ? null :
		  new Long(evento.contador.longValue());
	 this.usuario = (this.usuario == null) ? null : new String(evento.usuario);
	 this.tipo = (this.tipo == null) ? null : new Integer(evento.tipo.intValue());
	 this.aplicacion = (this.aplicacion == null) ? null :
		  new String(evento.aplicacion);
	 this.componente = (this.componente == null) ? null :
  ...
  /**
	...
	* @param evento DEvent Evento que se desea adjuntar
	*/
  ...
  /**
	...
	* miembros contador, usuario y aplicacion de tal forma que sean iguales
	* a los del evento en el que estaba adjuntado
	* @return DEvent null si no hay evento adjunto o el evento ajunto cuando lo hay
	*/
